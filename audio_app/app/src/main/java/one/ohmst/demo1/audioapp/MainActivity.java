...
public class MainActivity extends NativeActivity {
    ...
    static {
        ...
        // The name "main" depends on your CMake configuration, must be
        // consistent here and inside AndroidManifect.xml
        System.loadLibrary("main");
    }

    private void hideSystemUI() {
        // This will put the view behind any cutouts and waterfalls on devices which have
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideSystemUI();
        // You can set IME fields here or in native code using MainActivity_setImeEditorInfoFields.
